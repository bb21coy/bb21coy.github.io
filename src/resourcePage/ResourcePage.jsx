    ...
    return (
        <div className="resource-page">
            <div className='sidebar'>
                <div>
                    <input type="radio" name="selector" id="target" defaultChecked={true} />
            ...
            <div className='content'>
                ...
                <div className='overview'>
                    <a href="#bb-history">BB History</a>
                    <a href="#bb-singapore-story">The BB Singapore Story</a>
                    <a href="#bb-international">Overview of BB International and BB Asia</a>
                    <a href="#bb-vesper">BB Vesper</a>
                    <a href="#table-grace">Table Grace</a>
                    <a href="#bb-songs">BB Songs</a>
                    <a href="#bb-object">BB Object, Motto and Logo</a>
                    <a href="#uniform">Uniform</a>
                    <a href="#award-scheme">Award Scheme</a>
                    <a href="#company-organisation">Company Organisation and Ranks</a>
                    <a href="#company-history">Company Life and History</a>
                </div>
                ...
                <img src="handshake.png" alt="BB Handshake" className='custom-image-250' />
                ...
                <h4>BB Logo</h4>
                <img src='bb-logo.jpg' alt="BB Logo" className='custom-image-150' />
                ...
                <div className='badges'>
                    <img src="badges.png" alt="Justin's Badges" className='custom-image-250' />
                ...
                <h4>Leadership</h4>
                <div className='badge-explanation'>
                ...
                <div className='ranks-list'>
                    <div className='rank-item'>Recuit (REC)</div>
                    <div className='rank-item'>Private (PTE)</div>
                    ...
                    <tbody>
                        {appointment.map((appointment, index) => (
                            <tr key={index}>
                                ...
                                <td>{appointment.account_id.account_name}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
